        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <Link to="/" className="flex items-center gap-3 group">
              <div className="w-12 h-12 rounded-xl bg-white p-1 shadow-md border border-slate-200 group-hover:scale-105 transition-transform overflow-hidden flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                <p className="text-[11px] sm:text-[12px] font-extrabold text-amber-600 tracking-wide uppercase -mt-0.5">
                  हर काम के लिए
                </p>
              </div>
            </Link>
            ...
            {/* Desktop Direct Booking CTAs: WhatsApp, Call, Tatkal, Book */}
            <div className="hidden md:flex items-center gap-2 sm:gap-3">
              
              {/* WhatsApp Quick Link */}
              <button
                onClick={openWhatsAppDirect}
                className="inline-flex items-center gap-1.5 bg-[#25D366] hover:bg-[#20BD5A] text-white px-3 py-2 rounded-xl text-xs font-bold shadow-sm transition-all active:scale-95"
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 bg-slate-900 hover:bg-black text-white px-3 py-2 rounded-xl text-xs font-bold shadow-sm transition-all"
              >
                <Phone className="w-3.5 h-3.5 text-amber-400" />
                <span>{DISPLAY_PHONE}</span>
              </a>

              {/* Tatkal Booking Separate Trigger */}
              <button
                onClick={() => {
                  setIsTatkalModalOpen(true);
                }}
                className="inline-flex items-center gap-1.5 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-slate-950 px-3 py-2 rounded-xl font-extrabold text-xs shadow-md shadow-amber-500/20 hover:shadow-lg transition-all transform hover:-translate-y-0.5 active:translate-y-0 border border-amber-400/50"
                title="⚡ Tatkal Urgent Booking (6-Hour Notice)"
              >
                <Zap className="w-4 h-4 fill-slate-950" />
                <span>Tatkal Booking</span>
              </button>

              {/* Book Labour Primary Trigger */}
              <button
                onClick={() => {
                  setModalBookingType('NORMAL');
            ...
            <div className="flex items-center gap-2 md:hidden">
              <div className="flex items-center gap-1 px-2 py-1 rounded-full bg-slate-100 text-[11px] font-semibold text-slate-700">
              ...
              <button
                onClick={() => {
                  setModalBookingType('TATKAL');
                  setIsBookingModalOpen(true);
                }}
                className="bg-amber-500 text-slate-950 p-2 rounded-xl text-xs font-black flex items-center gap-1 shadow-sm"
          ...
          <div className="md:hidden bg-white border-b border-slate-200 px-4 pt-2 pb-6 space-y-3">
            ...
            <div className="pt-4 border-t border-slate-100 space-y-2">
              <button
                ...
                className="w-full bg-gradient-to-r from-amber-500 to-amber-600 text-slate-950 py-3 rounded-xl font-extrabold shadow-md flex items-center justify-center gap-2 text-sm border border-amber-400"
              >
                <Zap className="w-4 h-4 fill-slate-950" />
                ⚡ Tatkal Booking (6-Hour Notice)
              </button>
